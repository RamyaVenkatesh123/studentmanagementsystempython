...
def connect_database():
    def connect():
        global mycursor,con
        try:
            con=pymysql.connect(host='localhost',user='root',password='Ramya')
            mycursor=con.cursor()
        except:
...
logo_image=PhotoImage(file='C:\\Users\\ramya\\Lib\\site-packages\\Student Management System-20230825T162504Z-001\\Student Management System\\student.png')
